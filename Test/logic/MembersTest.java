...
public class MembersTest {
    ...
    @Test
    public void testKaj(){
        MembersHardcoded instance = new MembersHardcoded();
        ArrayList<String> l = instance.Hej();
        String expected = "Kaj";
        String actual = l.get(0);
        assertEquals(expected, actual);
    }
    
    /** 
      /**     
        Members instance = new Members("", 0, 0);
        String expResult = "";
